# File Organizer - Nebula Roadmap

## Project Overview
File Organizer - An intelligent CLI tool that automatically sorts files into folders based on type, date, or custom rules
...
## Technology Stack
- **Framework:** Python
- **Libraries:** pathlib (file ops), watchdog (file monitoring), PyYAML (config), rich (UI)
- **Core:** File system operations, rules engine, undo system
